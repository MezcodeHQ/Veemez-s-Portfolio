...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    try {
        ...
        $mail->SMTPAuth   = true;
        $mail->Username   = 'mezcode.my@gmail.com';
        $mail->Password   = 'wrxs drpf qzny sdbm';
        $mail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS;
        $mail->Port       = 587;

        $mail->setFrom('mezcode.my@gmail.com', 'VEEMESWARAN GUNASEKARAN');
        $mail->addAddress('mezcode.my@gmail.com');
